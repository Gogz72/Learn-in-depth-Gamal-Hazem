...
C_SRCS += \
../Src/STM32F103CX_GPIO.c \
../Src/main.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/STM32F103CX_GPIO.o \
./Src/main.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/STM32F103CX_GPIO.d \
./Src/main.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
Src/STM32F103CX_GPIO.o: ../Src/STM32F103CX_GPIO.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -DDEBUG -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/STM32F103CX_GPIO.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
